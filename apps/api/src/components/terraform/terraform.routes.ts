...
export async function terraformRouter(
  ...
  fastify.get(
    "/v1/terraform/deployPullRequest",
    terraformController.pullRequestTerraform,
  );
  ...
  fastify.post(
    "/v1/terraform/registerSSH",
    terraformController.registerSSHKeys,
  );
  fastify.post(
    "/v1/terraform/pullRequest/:pull",
    terraformController.pullRequest,
  );
  fastify.post(
    "/v1/terraform/deleteDroplet",
    terraformController.deleteDroplet,
  );
}
