...
import {
  ...
  EnvState,
  AppVariable,
} from "../../../../backoffice/types/interfaces";

async function deploy(request: FastifyRequest, reply: FastifyReply) {
  const headers = {
...
export const terraformController = Object.freeze({
  deploy,
  pullRequestTerraform,
  script,
  terrafromVar,
  deleteFile,
  generateSSHKeys,
