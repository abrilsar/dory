...
export default function CardDB({ deploy, index }: props) {
  ...
  return (
    <div
      className="w-full max-w-[26rem] h-72 bg-white mt-6 rounded-2xl mx-0 sm:mx-4 md:mx-2 lg:mx-3 shadow-xl z-10 overflow-hidden"
      onClick={handleClick}
    >
...
export function CardDBSkeleton() {
  return (
    <div className="w-full mt-6 h-72 rounded-2xl px-2 sm:px-4 md:px-2 lg:px-3 shadow-lg z-10 bg-gray-200 animate-pulse"></div>
  );
}
