...
export default function FieldEnv({
  ...
  return (
    <>
      ...
      >
        <div
          className={`mt-2 sm:mt-0 mr-2 sm:mr-8 py-0 flex items-center gap-2 sm:gap-4 sm:px-0 ${showValidation && firstInput && "pt-6 lg:mt-0"}`}
        >
      ...
      <Field
        ...
        defaultValue={`${keyEnv}.deploy-tap.site`}
        name="domain"
        min="sm:min-w-32"
        inputName={
